...
{
    /* Linux implementation of this function. */
#if 0
    struct acpi_ioremap *map;
    void __iomem *virt;
...
#else
    /* Kitten implemention of this function. */
...
{
    /* Linux-specific implementation of this function. */
#if 0
    struct acpi_ioremap *map;
...
#else
    /* Kitten-specific implementation of this function. We realy don't have
     * to do anything, since we do not create state after mapping.
     */
    iounmap(virt);
#endif
}
...
void __init early_acpi_os_unmap_memory(void __iomem *virt, acpi_size size)
{
    ...
    if (!acpi_gbl_permanent_mmap)
        __acpi_unmap_table(virt, size);
#else
    /* Kitten implementation of this function */
    return;
#endif
}
