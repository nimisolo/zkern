...
interrupts_init(void)
{
     ...
     */
    set_idtvec_handler( LWK_XCALL_FUNCTION_VECTOR,   &arch_xcall_function_interrupt   );
    set_idtvec_handler( LWK_XCALL_RESCHEDULE_VECTOR, &arch_xcall_reschedule_interrupt );
}
